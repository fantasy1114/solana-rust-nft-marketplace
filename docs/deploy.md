...
```json
"deploy:gh": "yarn export && gh-pages -d ../../build/web --repo https://github.com/svgvr8/svgvr8.github.io -t true",
"deploy": "cross-env ASSET_PREFIX=/metaplex/ yarn build && yarn deploy:gh",
```

There are 2 things to change:

- specify your repo URL instead of `https://github.com/sagarxyadav/deploy` (for example, `https://github.com/my-name/my-metaplex`)
